      ...
      <main id="top">
        <section className="hero section">
          ...
          <div className="hero-cta">
            <a className="btn btn--primary" href={LINKS.app} {...APP_LINK_PROPS}>
              {HERO.primaryCta}
            </a>
            <Link className="btn btn--ghost" to={ROUTES.security}>
              {HERO.secondaryCta}
            </Link>
          </div>
        </section>
        ...
        <section className="section section--card safety-model" id="safety-model" aria-labelledby="safety-model-heading">
          <h2 id="safety-model-heading" className="section-title">
            {SAFETY_MODEL.title}
          </h2>
          <p className="section-lead">{SAFETY_MODEL.lead}</p>
          <ul className="about-list">
            {SAFETY_MODEL.bullets.map((item) => (
              <li key={item}>{item}</li>
            ))}
          </ul>
          <p className="safety-model-cta">
            <Link className="btn btn--ghost btn--sm" to={SAFETY_MODEL.ctaPath}>
              {SAFETY_MODEL.ctaLabel}
            </Link>
          </p>
        </section>

        <section className="section section--card founder-section" id="founder" aria-labelledby="founder-heading">
          <h2 id="founder-heading" className="section-title">
            {AUTHOR.sectionTitle}
          </h2>
          <p className="section-lead">{AUTHOR.subtitle}</p>
        ...
        <section className="section section--card" id="technical-contributions">
          <h2 className="section-title">{TECHNICAL_CONTRIBUTIONS.title}</h2>
        ...
        <section className="section section--card" id="milestones">
        ...
        <section className="section" id="project-links">
          ...
          <p className="section-lead">
            Use CryPrice or review public engineering repositories and source trees.
          </p>
